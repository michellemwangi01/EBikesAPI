...
SECRET_KEY = 'django-insecure-+zina^xo2s9kr*854y^c73$nkl!=2ijxghma_68)@ziya7*=3e'
...
# Iam using the fleetbase opensounrce application. I want to allow a 3rd part app to make api calls that will allow fleetbase to create an order to the'